 ...
 * Приоритет:
 * 1. manual_premium (для тестирования)
 * 2. manual_pro (для тестирования)
...
export function canGenerateDialog(usageData, profile) {
  ...
  // Проверяем дневной и недельный лимит
  return dailyAvailable > 0 && weeklyUsed < limits.weeklyMax;
}
